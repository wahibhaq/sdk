...
public void initiateLogin()
{
    ...
    try {
		...
		jsonArgs.putOpt("key", 123);
		
	} catch (JSONException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
		
		displayLogsOnScreen("Initiate Login : Error with json sent !");

	}
    
   // socket.emit("login", jsonArgs);
    ...
    socket.emit("login", new IOAcknowledge() {
		...
		public void ack(Object... arg0) {
            ...
            isLoggedIn = true;
			Log.i("socket","SocketIOLayer login logged in success !!");
